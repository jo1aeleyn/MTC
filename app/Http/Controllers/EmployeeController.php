    ...
    public function export(Request $request)
{
    ...
    // Add the section title and columns in row 2 and row 3
    fputcsv($output, ['Employee Details', '', '', '', '', '', '', '']);
    fputcsv($output, [
        'No', 'Employee Number', 'First Name', 'Last Name', 'Contact Number', 'Email', 'Date Hired'
    ]);

    // Add the records for Employee details in row 4 and onwards
    $rowIndex = 4;  // To keep track of the row number
    foreach ($employeeData as $index => $employee) {
        ...
        // "Applications" section (merged title in row 2)
        ...
        // "Education" Section (merged title in row 2)
        ...
        // "Employment History" Section (merged title in row 2)
        ...
        // "Company" Section (merged title in row 2)
        ...
        // "Family" Section (merged title in row 2)
        ...
        // "Training" Section (merged title in row 2)
        ...
        // "Emergency Contacts" Section (merged title in row 2)
        ...
        // Add blank line after each employee section
        fputcsv($output, []);
    }
